...
**The course is over and the site will not be further updated. It will remain here for reference. For updates and more comprehensive materials, please see our online site/course [Simulation Modeling in Immunology](https://andreashandel.github.io/SMIcourse/).**


Welcome to the website for the course/module called [Infectious Diseases, Immunology and Within-Host Models](https://si.biostat.washington.edu/suminst/sismid2020/modules/MD2010), which is part of the [2020 Summer Institute in Statistics and Modeling in Infectious Diseases (SISMID)](https://si.biostat.washington.edu/suminst/sismid). The course is taught by [Andreas Handel](https://www.andreashandel.com/) and [Paul Thomas](https://www.stjude.org/directory/t/paul-thomas.html). 
